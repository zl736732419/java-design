 ...
 */
public class PullObserverImpl2 implements PullObserver {

    private String name;
    private PullSubject subject;
    private String data = null;//这里用于缓存从消息中心获取的数据

    public PullObserverImpl2(String name, PullSubject subject) {
        this.name = name;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PullObserverImpl2)) {
            return false;
        }

        PullObserverImpl2 other = (PullObserverImpl2) obj;
